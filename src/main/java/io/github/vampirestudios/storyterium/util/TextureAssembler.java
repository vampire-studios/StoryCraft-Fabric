...
public class TextureAssembler {
    ...
    //Outfits
    private Identifier outfit1Female = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/clothes/outfit1.png");
    private Identifier outfit2Female = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/clothes/outfit2.png");
    private Identifier outfit3Female = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/clothes/outfit3.png");
    private Identifier swimmingOutfitFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/clothes/swimming_suite.png");
    private Identifier pyjamasFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/clothes/pyjamas.png");

    private Identifier outfit1Male = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/clothes/outfit1.png");
    private Identifier outfit2Male = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/clothes/outfit2.png");
    private Identifier outfit3Male = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/clothes/outfit3.png");
    private Identifier swimmingOutfitMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/clothes/swimming_suite.png");
    private Identifier pyjamasMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/clothes/pyjamas.png");

    //Skin
    private Identifier lightSkinMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/skin/light.png");
    private Identifier medSkinMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/skin/medium.png");
    private Identifier darkSkinMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/skin/dark.png");
    private Identifier lightSkinFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/skin/light.png");
    private Identifier mediumSkinFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/skin/medium.png");
    private Identifier darkSkinFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/skin/dark.png");

    //Eyes Female
    private Identifier blackEyesFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/eyes/black.png");
    private Identifier blueEyesFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/eyes/blue.png");
    private Identifier brownEyesFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/eyes/brown.png");
    private Identifier greenEyesFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/eyes/green.png");
    private Identifier limeEyesFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/eyes/lime.png");
    private Identifier pinkEyesFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/eyes/pink.png");
    private Identifier yellowEyesFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/eyes/yellow.png");

    //Eyes Male
    private Identifier blackEyesMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/eyes/black.png");
    private Identifier blueEyesMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/eyes/blue.png");
    private Identifier brownEyesMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/eyes/brown.png");
    private Identifier greenEyesMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/eyes/green.png");
    private Identifier limeEyesMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/eyes/lime.png");
    private Identifier pinkEyesMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/eyes/pink.png");
    private Identifier yellowEyesMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/eyes/yellow.png");

    //Hair male
    private Identifier blackHairMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/black1.png");
    private Identifier blackHairMale2 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/black2.png");
    private Identifier blackHairMale3 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/black3.png");
    private Identifier blackHairMale4 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/black4.png");
    private Identifier brownHairMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/brown1.png");
    private Identifier brownHairMale2 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/brown2.png");
    private Identifier brownHairMale3 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/brown3.png");
    private Identifier brownHairMale4 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/brown4.png");
    private Identifier blondeHairMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/blonde1.png");
    private Identifier blondeHairMale2 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/blonde2.png");
    private Identifier blondeHairMale3 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/blonde3.png");
    private Identifier blondeHairMale4 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/blonde4.png");
    private Identifier redHairMale = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/red1.png");
    private Identifier redHairMale2 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/red2.png");
    private Identifier redHairMale3 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/red3.png");
    private Identifier redHairMale4 = new Identifier(Storyterium.MOD_ID, MALE_LOCATION + "/hair/red4.png");

    //Hair female
    private Identifier blondeHairFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/blonde1.png");
    private Identifier blondeHairFemale2 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/blonde2.png");
    private Identifier blondeHairFemale3 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/blonde3.png");
    private Identifier blondeHairFemale4 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/blonde4.png");
    private Identifier brownHairFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/brown1.png");
    private Identifier brownHairFemale2 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/brown2.png");
    private Identifier brownHairFemale3 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/brown3.png");
    private Identifier brownHairFemale4 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/brown4.png");
    private Identifier blackHairFemale = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/black1.png");
    private Identifier blackHairFemale2 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/black2.png");
    private Identifier blackHairFemale3 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/black3.png");
    private Identifier blackHairFemale4 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/black4.png");
    private Identifier redHairFemale1 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/red1.png");
    private Identifier redHairFemale2 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/red2.png");
    private Identifier redHairFemale3 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/red3.png");
    private Identifier redHairFemale4 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/red4.png");
    private Identifier pinkHairFemale1 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/pink1.png");
    private Identifier pinkHairFemale2 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/pink2.png");
    private Identifier pinkHairFemale3 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/pink3.png");
    private Identifier pinkHairFemale4 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/pink4.png");
    private Identifier gingerHairFemale1 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/ginger1.png");
    private Identifier gingerHairFemale2 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/ginger2.png");
    private Identifier gingerHairFemale3 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/ginger3.png");
    private Identifier gingerHairFemale4 = new Identifier(Storyterium.MOD_ID, FEMALE_LOCATION + "/hair/ginger4.png");

    private Identifier femaleBaker1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/baker1.png");
    private Identifier femaleMiner1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/miner1.png");
    private Identifier femaleMiner2 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/miner2.png");
    private Identifier femaleGuard1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/guard1.png");
    private Identifier femalePriest1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/priest1.png");
    private Identifier femaleLibrarian1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/librarian1.png");
    private Identifier femaleButcher1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/butcher1.png");
    private Identifier femaleFarmer1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/farmer1.png");
    private Identifier femaleBlackmith1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/blacksmith1.png");
    private Identifier femaleWarrior1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/female/warrior1.png");

    private Identifier maleBaker1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/baker1.png");
    private Identifier maleMiner1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/miner1.png");
    private Identifier maleMiner2 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/miner2.png");
    private Identifier maleGuard1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/guard1.png");
    private Identifier malePriest1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/priest1.png");
    private Identifier maleLibrarian1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/librarian1.png");
    private Identifier maleButcher1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/butcher1.png");
    private Identifier maleFarmer1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/farmer1.png");
    private Identifier maleBlackmith1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/blacksmith1.png");
    private Identifier maleWarrior1 = new Identifier(Storyterium.MOD_ID, PROFESSION_LOCATION + "/male/warrior1.png");
    ...
    public TextureAssembler(FamiliarsEntity familiarsEntity) {
        ...
        this.profession = familiarsEntity.getFamiliarsProfession().getProfession().getPath();
    }
