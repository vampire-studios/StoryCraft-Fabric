...
public class Util {
    ...
    private static String readResource(String path) {
        ...
        try {
            data = IOUtils.toString(new InputStreamReader(Objects.requireNonNull(Storyterium.class.getClassLoader().getResourceAsStream(location))));
        } catch (IOException e) {
    ...
    public static String httpGet(String url) {
        try {
            ...
            Storyterium.LOGGER.error("Failed to GET from: " + url);
        }
        return "";
    }
}